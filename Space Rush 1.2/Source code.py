...
# load space1
spacebg = pygame.image.load('spacebg1.png')
...
while running:
        ...
        if bullet_hitbox.x < 0 and shine > 20 and hitbox___.y == 400:
            bullet_hitbox.y = 400
            bullet_hitbox.x = 530
            laser_fx.play()
        
        if bullet_hitbox.x < 0 and shine > 20 and hitbox___.y == 132:
            bullet_hitbox.y = 132
            bullet_hitbox.x = 530
            laser_fx.play()

        if bullet__hitbox.x < 0 and shine > 35 and alien_hitbox.y == 30:
            bullet__hitbox.y = 30
            bullet__hitbox.x = 630
            laser_fx.play()
        
        if bullet__hitbox.x < 0 and shine > 35 and alien_hitbox.y == 532:
            bullet__hitbox.y = 532
            bullet__hitbox.x = 630
            laser_fx.play()
